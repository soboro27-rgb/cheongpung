...
export const metadata: Metadata = {
  title: "보안·법적 고지",
  description:
    "캣피쉬이펙트의 데이터 처리 정책과 법적 고지 사항을 안내합니다.",
};
      ...
      <section className="section">
        <div className="mx-auto max-w-content px-5 sm:px-8">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-text-muted">
            캣피쉬이펙트를 회의실에 도입하기 전, 아래 데이터 처리 방식과
        ...
        <div className="mx-auto max-w-content px-5 sm:px-8">
          <div className="card border-lime-mint/40 p-7 sm:p-9">
            ...
            <p className="mt-3 text-sm leading-relaxed text-text-primary">
              ...
              직접 라우팅합니다. 캣피쉬이펙트는 데이터 처리자가 아니며,
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <div className="card p-7">
              ...
              <p className="mt-3 text-sm leading-relaxed text-text-muted">
                ...
                동의 절차가 반드시 필요합니다. 고객사는 캣피쉬이펙트 사용
            ...
            <div className="card p-7">
              ...
              <p className="mt-3 text-sm leading-relaxed text-text-muted">
                캣피쉬이펙트는 회의 내용의 옳고 그름을 판단하지 않습니다.
